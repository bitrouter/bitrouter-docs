---
title: Cherry Studio
description: Configure and Use AiMo in Cherry Studio
---
...
1. Open the [AiMo Web Dashboard](https://aimo.network/dashboard).
...
4. Configure the provider:
   - API Host / Base URL / Endpoint: `https://beta.aimo.network/api` (Base URL preview should be exactly `https://beta.aimo.network/api/v1/chat/completions`)
...
- General connectivity
  - Confirm Base URL is exactly `https://beta.aimo.network/api/v1`.
