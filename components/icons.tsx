...
export function TelegramIcon(props: ComponentProps<"svg">) {
  return (
    ...
    >
      ...
      <path d="M22,9V7H21V5H20V4H19V3H17V2H15V1H9V2H7V3H5V4H4V5H3V7H2V9H1v6H2v2H3v2H4v1H5v1H7v1H9v1h6V22h2V21h2V20h1V19h1V17h1V15h1V9Zm-5,2H16v3H15v4H14V17H13V16H12V15H10V14h1V13h1V12H10v1H9v1H7V13H5V12H7V11H9V10h2V9h3V8h2V7h1Z" />
    </svg>
  );
}
