---
title: Overview
description: Point a coding agent or runtime at BitRouter — Claude Code, Codex, OpenCode, DeepSeek Harness, Pi — and run it on any model in the registry.
---
...
<Cards>
  ...
  <Card title="DeepSeek Harness" href="/docs/integrations/deepseek-harness" description="Custom provider route in settings.yaml" />
...
Two of these share a name with a [model source](/docs/guides/models), and it's worth keeping them straight:

| You want to… | Use |
| --- | --- |
| Run the **Claude Code CLI** on any model | [Claude Code](/docs/integrations/claude-code) (harness) |
| Spend your **Claude plan** as tokens | [Claude subscription](/docs/guides/claude-subscription) (model) |
| Run the **Codex CLI** on any model | [Codex](/docs/integrations/codex) (harness) |
| Spend your **ChatGPT plan** as tokens | [Codex subscription](/docs/guides/codex-subscription) (model) |
