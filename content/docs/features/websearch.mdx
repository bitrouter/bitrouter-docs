...
- [Toolsets](/docs/features/toolsets) — how tools advertised on a request are bundled and namespaced.
- [Observability](/docs/features/observability) — every nested search call shows up in usage like any other.
