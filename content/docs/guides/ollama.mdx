...
Then [start BitRouter and send a request](/docs/guides/models#start-bitrouter-and-send-a-request). Use the provider-qualified id `ollama:llama3.1` to pin the request, or the bare `llama3.1` to let BitRouter cascade.
