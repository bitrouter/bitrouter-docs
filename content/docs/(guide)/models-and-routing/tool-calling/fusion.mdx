...
- [Sub-agent](/docs/models-and-routing/tool-calling/subagent) — delegate a self-contained task to a single worker model
- [Advisor](/docs/models-and-routing/tool-calling/advisor) — consult one stronger model mid-task
