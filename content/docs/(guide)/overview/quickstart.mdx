...
<Callout type="info">
The `/bitrouter` skill *drives* BitRouter; the [AgentSkills gateway](/docs/usage/mcp-gateway) is the opposite direction — BitRouter *serving* skills as governed, routable resources to the agents behind it.
</Callout>
