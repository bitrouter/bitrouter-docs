...
| `minimax/minimax-m2.5` | 192K | text | ✅ | $0.225 | $0.0225 | $0.9 |
...
| `qwen/qwen3.6-flash` | 1M | text, image | — | $0.1875 | $0.01875 | $1.125 |
...
| `stepfun/step-3.5-flash` | 256K | text | ✅ | $0.072 | $0.01425 | $0.216 |
| `stepfun/step-3.7-flash` | 256K | text, image | ✅ | $0.15 | $0.03 | $0.8625 |
