---
title: Models
description: On BitRouter a model is an aggregate served by many providers.
---
...
- [Provider selection](/docs/models-and-routing/provider-selection) — how providers behind one model are ranked.
- [Model fallback](/docs/models-and-routing/model-fallback) — pass an ordered list and walk it on failure.
- [Model variants](/docs/models-and-routing/model-variants) — the `:cost` / `:latency` / `:throughput` suffixes.
- [Presets](/docs/models-and-routing/presets) — named, reusable routing configurations.
- [Structured outputs](/docs/models-and-routing/structured-outputs) — enforce a JSON schema across providers.
- [Add external keys (BYOK)](/docs/models-and-routing/byok) — route through your own provider account.
- [Local & private models](/docs/integrations/models) — point BitRouter at your own server.
- [Managed provider & pricing](/docs/overview/supported-models) — the hosted provider and the full catalog.
