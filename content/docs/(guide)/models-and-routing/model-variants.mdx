...
- [Guardrail](/docs/models-and-routing/guardrails) model allowlists/denylists and BYOK rules judge `anthropic/claude-sonnet-4.6:cost` exactly as `anthropic/claude-sonnet-4.6` — a profile can never widen or bypass a policy.
- [BYOK](/docs/models-and-routing/bring-your-own-provider) providers still rank ahead of platform providers; the profile orders providers *within* each tier.
