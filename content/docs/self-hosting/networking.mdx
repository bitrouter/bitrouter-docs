...
| `POST /mcp/{server}` | MCP gateway — see [MCP gateway](/docs/usage/mcp-gateway) |
...
<Cards>
  ...
  <Card title="OpenTelemetry" href="/docs/evals-and-tracing/opentelemetry" description="The metrics path that actually carries data." />
</Cards>
