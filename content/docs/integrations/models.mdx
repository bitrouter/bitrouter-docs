...
For the concepts behind this — provider selection, fallback, and registry detection — see [Models](/docs/concepts/models) and [Local & private models](/docs/features/local-models).
