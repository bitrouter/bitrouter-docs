...
use [`bitrouter.yaml`](/docs/usage/configuration) instead — you do not need to write
a plugin.
</Callout>
...
<Cards>
  <Card title="Self-host BitRouter" href="/docs/self-hosting" description="Run the router you compiled your plugin into, in production." />
  <Card title="Guardrails" href="/docs/models-and-routing/guardrails" description="The content-firewall plugin, as a worked reference." />
  <Card title="OpenTelemetry" href="/docs/evals-and-tracing/opentelemetry" description="OTLP trace + metric export, built on the observe plugin." />
