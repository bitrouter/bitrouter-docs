...
For an agent outside the bundled catalog, generate a configuration stub and review it before adding it to the [`bitrouter.yaml` router policy](/docs/configuration/policy):
