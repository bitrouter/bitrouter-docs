...
- Install the `bitrouter` CLI and generate a wallet keypair
...
For source code and contributions, see the [agent-skills repository](https://github.com/bitrouter/agent-skills).
...
Create an `bitrouter-cli.toml` configuration:
...
- Monitor usage with `bitrouter router get-balance`
...
**CLI Commands:**
- `bitrouter --help` - Full command reference
- `bitrouter chat --help` - Chat options
- `bitrouter mcp --help` - MCP commands
- `bitrouter a2a --help` - A2A commands
