...
- Each model ID must resolve to a registered model in the [registry](https://github.com/bitrouter/provider-registry). Unknown IDs return `400` before any upstream attempt.
