...
具体 Agent 运行时（Claude Code、OpenClaw、Codex CLI、OpenCode 等）的接入方法详见 Cookbook。

<Cards>
  <Card title="Cookbook" href="/docs/integrations" description="覆盖每个 Agent 运行时的分步接入指南" />
  ...
  <Card title="API 参考" href="/docs/reference/api-reference" description="端点与 schema 文档" />
