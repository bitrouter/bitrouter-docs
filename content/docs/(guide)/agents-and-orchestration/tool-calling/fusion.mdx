...
- [Sub-agent](/docs/agents-and-orchestration/tool-calling/subagent) — delegate a self-contained task to a single worker model
- [Advisor](/docs/agents-and-orchestration/tool-calling/advisor) — consult one stronger model mid-task
