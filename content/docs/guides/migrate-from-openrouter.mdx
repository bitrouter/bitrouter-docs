...
<Cards>
  ...
  <Card title="Agent Cookbook" href="/docs/integrations" description="Integration guides for specific agents" />
  <Card title="API Reference" href="/docs/reference/api-reference" description="Complete API documentation" />
</Cards>
