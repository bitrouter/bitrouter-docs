...
description: AiMo Network TypeScript SDK — 钱包身份验证、支付和 AI 推理
---

# TypeScript SDK

AiMo Network 官方 TypeScript SDK。提供基于钱包的身份验证 (SIWx)、自动支付处理 (x402) 以及 OpenAI 兼容的聊天补全接口。

## 包

| 包 | 描述 | 版本 |
|----|------|------|
| [`@aimo.network/client`](/docs/sdk-reference/ts-client) | 核心客户端库 | 1.8.0 |
| [`@aimo.network/svm`](/docs/sdk-reference/ts-svm) | Solana 钱包支持 | 1.8.0 |
| [`@aimo.network/evm`](/docs/sdk-reference/ts-evm) | Ethereum / Base 钱包支持 | 1.8.0 |
| [`@aimo.network/provider`](/docs/sdk-reference/ts-provider) | Vercel AI SDK provider | 1.8.0 |
| `@aimo.network/react` | React hooks 和组件 | 即将推出 |
