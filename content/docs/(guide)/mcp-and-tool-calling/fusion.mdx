...
- [Sub-agent](/docs/mcp-and-tool-calling/subagent) — delegate a self-contained task to a single worker model
- [Advisor](/docs/mcp-and-tool-calling/advisor) — consult one stronger model mid-task
