...
<Cards>
  ...
  <Card title="Model fallback" href="/docs/configuration/models#fallback-chains" description="Fall back from local inference to a hosted source." />
  <Card title="Router policy" href="/docs/configuration/policy" description="Place the provider block in the complete desired-state contract." />
</Cards>
