...
- **The [MCP gateway](/docs/usage/mcp-gateway).** BitRouter sits *in front of* your own MCP servers, proxying their tools to agents with auth, access control, and identity forwarding. There BitRouter is the middle, not the endpoint.

The first two are how you reach BitRouter; the gateway is how BitRouter reaches your tools. See [Tools](/docs/usage/mcp-gateway) for the gateway, and [Agent Skills](/docs/usage/skills) for the third way an agent drives BitRouter.
