...
- [`bitrouter tui`](/docs/usage/cli/harnesses#bitrouter-tui) — the full flag reference
- [`bitrouter launch`](/docs/usage/cli/harnesses#bitrouter-launch) — one harness, no console
- [`bitrouter spawn`](/docs/usage/cli/harnesses#bitrouter-spawn) — a headless ACP subagent
- [MCP Server](/docs/usage/mcp) — the `fleet` backend the orchestrator drives
- [Subagent](/docs/gateway-and-routing/subagent) — the routing feature underneath
