---
title: Python SDK
description: BitRouter Python SDK — 异步钱包身份验证、支付和 AI 推理
---

# Python SDK

BitRouter 官方 Python SDK。提供异步的基于钱包的身份验证 (SIWx)、自动支付处理 (x402) 以及 OpenAI 兼容的聊天补全接口。
