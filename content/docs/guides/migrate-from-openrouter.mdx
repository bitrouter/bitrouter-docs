...
| **Agent Features** | Basic routing | Headless CLI, MCP/ACP gateways, server-tool loop |
...
<Cards>
  ...
  <Card title="Configuration" href="/docs/models-and-routing/virtual-model" description="Advanced routing and configuration options" />
  <Card title="Integrations" href="/docs/integrations/harnesses" description="Integration guides for specific agents" />
