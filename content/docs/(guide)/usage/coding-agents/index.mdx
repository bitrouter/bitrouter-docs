...
| Spend a Claude Pro or Max subscription | [Claude Code](/docs/usage/coding-agents/claude-code#use-a-claude-subscription) |
| Run the Codex application | [Codex](#codex) |
| Spend a ChatGPT Plus or Pro subscription | [Codex](/docs/usage/coding-agents/codex#use-a-codex-subscription) |
...
<Cards>
  <Card title="Claude Code" href="/docs/usage/coding-agents/claude-code" description="ACP, native launch, manual configuration, and Claude subscription login." />
  <Card title="Codex" href="/docs/usage/coding-agents/codex" description="ACP, native launch, permanent configuration, and ChatGPT subscription login." />
