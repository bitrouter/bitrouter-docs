...
See [Observability](/docs/features/observability) for the span model and
attribution, and [Export traces to your OTel backend](/docs/guides/export-telemetry)
for per-backend configs.
...
<Cards>
  ...
  <Card title="Observability" href="/docs/features/observability" description="OTLP trace + metric export and per-request attribution." />
