...
const finalPath = {
  ...
  "mcp":"/docs/gateway-and-routing/mcp-gateway","acp":"/docs/gateway-and-routing/acp-gateway",
  "agentskills":"/docs/gateway-and-routing/mcp-gateway",
...
pairs.push(
  ...
  ["/docs/get-started/set-up-routing", "/docs/gateway-and-routing/provider-selection"],
  ...
  ["/docs/features/toolsets", "/docs/gateway-and-routing/server-tools"],
  ...
  // gateway pages consolidated out of features/ and the section renamed
  // models-and-routing → gateway-and-routing (2026-08)
  ...
  ["/docs/gateway-and-routing/tools", "/docs/gateway-and-routing/mcp-gateway"],
  ["/docs/gateway-and-routing/agents", "/docs/gateway-and-routing/acp-gateway"],
  ["/docs/features", "/docs/gateway-and-routing/guardrails"],
  ["/docs/features/guardrails", "/docs/gateway-and-routing/guardrails"],
  ...
  ["/docs/features/tools", "/docs/gateway-and-routing/mcp-gateway"],
  ["/docs/features/server-tools", "/docs/gateway-and-routing/server-tools"],
  ["/docs/features/websearch", "/docs/gateway-and-routing/websearch"],
  ["/docs/features/web-fetch", "/docs/gateway-and-routing/web-fetch"],
  ["/docs/features/agents", "/docs/gateway-and-routing/acp-gateway"],
  ["/docs/features/subagent", "/docs/gateway-and-routing/subagent"],
  ["/docs/features/advisor", "/docs/gateway-and-routing/advisor"],
  ["/docs/features/fusion", "/docs/gateway-and-routing/fusion"],
  ...
  ["/docs/integrations/tools", "/docs/gateway-and-routing/websearch"],
  ["/docs/integrations/exa", "/docs/gateway-and-routing/websearch"],
