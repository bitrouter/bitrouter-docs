...
| Artifact | What it is |
|----------|------------|
| `bitrouter.yaml` | An MVP router policy to try — see [Router policy](/docs/configuration/policy) |
...
<Cards>
  <Card title="Router policy" href="/docs/configuration/policy" description="Understand how bitrouter.yaml expresses the router's complete desired behavior." />
