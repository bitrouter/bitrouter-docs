...
<Cards>
  <Card title="Tracing" href="/docs/evals-and-tracing/tracing" description="Hosted request view — spend, tokens, and a per-request log, nothing to operate." />
  ...
  <Card title="Evaluation" href="/docs/evals-and-tracing/evaluation" description="The outcome signal and cost metering these traces carry." />
</Cards>
