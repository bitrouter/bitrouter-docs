---
title: TUI
description: Use BitRouter's terminal interface for interactive agent work, route selection, permission decisions, and attributed cost.
---
...
<Cards>
  <Card title="ACP Support" href="/docs/usage/acp" description="Agent discovery, headless runs, and the stdio adapter." />
