...
You are never limited to this list. Any model you run yourself — local or remote, a fine-tune, a private cluster — routes alongside these with the same ids, fallbacks, and variants: see [bring your own model](/docs/customization/models#custom-endpoints-and-models). To reach a model on your own provider account instead of ours, see [bring your own provider](/docs/customization/models#built-in-providers-with-your-own-key).
...
| `anthropic/claude-fable-5.1` | 1M | file, image, text | — | $10 | $0.25 | $50 |
...
| `deepseek/deepseek-v3.2` | 128K | text | ✅ | $0.21 | $0.105 | $0.315 |
| `deepseek/deepseek-v4-flash` | 256K | text | ✅ | $0.105 | $0.0021 | $0.21 |
| `deepseek/deepseek-v4-flash-0731` | 1M | text | ✅ | $0.14 | $0.0028 | $0.28 |
| `deepseek/deepseek-v4-pro` | 256K | text | ✅ | $1.305 | $0.10875 | $2.61 |
| `deepseek/deepseek-v4-pro-0813` | 1M | text | — | $0.435 | $0.003625 | $0.87 |
| `deepseek/deepseek-v4.1-flash` | 1M | image, text | — | $0.65 | $0.13 | $1.45 |
| `google/gemini-3.5-flash` | 1M | text, image, audio | — | $1.5 | $0.15 | $9 |
| `google/gemini-3.6-flash` | 1M | text, image, audio, video | — | $1.5 | $0.15 | $7.5 |
| `google/gemini-3.7-flash` | 1M | audio, file, image, text, video | — | $0.75 | $0.075 | $3.75 |
| `google/gemini-3.8-flash` | 1M | audio, file, image, text, video | — | $0.75 | $0.075 | $3.75 |
| `minimax/minimax-m2.7` | 192K | text | ✅ | $0.225 | $0.045 | $0.9 |
| `minimax/minimax-m3` | 1M | text, image | ✅ | $0.3 | $0.06 | $1.2 |
| `moonshotai/kimi-k2.6` | 256K | text | ✅ | $0.7125 | $0.12 | $3 |
| `moonshotai/kimi-k2.7-code` | 256K | text, image | ✅ | $0.7125 | $0.1425 | $3 |
| `moonshotai/kimi-k3` | 1M | text, image | ✅ | $2 | — | $6 |
...
| `openai/gpt-6-astra` | 1.1M | file, image, text | — | $10 | $1 | $50 |
...
| `qwen/qwen3.7-max` | 1M | text | — | $1.875 | $0.375 | $5.625 |
| `qwen/qwen3.7-plus` | 1M | text, image | — | $0.4 | $0.08 | $1.6 |
| `qwen/qwen3.8-2.4t-a95b` | 1M | text | ✅ | $2 | $0.17 | $6 |
| `qwen/qwen3.8-27b` | 1M | text, image, video | ✅ | $0.99 | — | $1.49 |
| `qwen/qwen3.8-flash` | 1M | image, text, video | — | $0.15 | $0.016 | $0.47 |
...
| `x-ai/grok-4.6` | 500K | text, image | — | $2 | $0.5 | $6 |
...
Because a model is an aggregate, requesting one starts [route resolution](/docs/configuration/routing): BitRouter filters eligible providers by the request's protocol and capabilities, then applies the configured priority order. Retryable failures advance through that chain. Presets and variants can further restrict providers or select a named policy, but alpha.31 does not yet use live cost or latency measurements to rank them.

## Calling these models

Every model above is reachable on hosted **BitRouter** — one account against `api.bitrouter.ai`, no upstream provider keys, no per-provider signups. You pay the provider token prices listed here with 0% token markup, and model routing is included. Third-party payment-processing fees may apply when adding funds; those top-up fees are separate from model pricing.

```bash
bro cloud login   # one-time device-flow sign-in
