  ...
  return (
    <>
      <Presence present={open}>
        <div
          className={cn(
            'fixed inset-0 z-30 backdrop-blur-xs bg-fd-overlay',
      ...
      <Presence present={open}>
        <div
          ...
          className={cn(
            ...
            'flex flex-col w-[min(680px,92vw)] h-[min(80vh,760px)] overflow-hidden',
            'border rounded-2xl shadow-xl bg-fd-card text-fd-card-foreground',
