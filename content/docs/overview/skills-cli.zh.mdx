...
如需源代码和贡献，请参阅 [agent-skills 仓库](https://github.com/AIMOverse/agent-skills)。
...
- 使用 `aimo router get-balance` 监控用量
- 对非关键任务使用更便宜的模型
- 适当缓存响应
...
- `aimo --help` - 完整命令参考
- `aimo chat --help` - 对话选项
- `aimo mcp --help` - MCP 命令
- `aimo a2a --help` - A2A 命令
