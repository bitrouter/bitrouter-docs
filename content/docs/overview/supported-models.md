...
<Callout type="info">
`:discount` never changes authorization. [Guardrail](/docs/features/guardrails) allowlists and [BYOK](/docs/models-and-routing/byok) rules judge `moonshotai/kimi-k2.6:discount` exactly as `moonshotai/kimi-k2.6` — the suffix can't widen or bypass a policy.
</Callout>
