...
#### Custom providers
Any provider registered in BitRouter's [provider registry](https://github.com/bitrouter/provider-registry) can support structured outputs through our unified schema format.
