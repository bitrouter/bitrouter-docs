...
- The site has **five docs tabs**, each a folder marked `"root": true`: Documentation (`content/docs/(guide)/`), Integrations (`content/docs/integrations/`), Self-hosting (`content/docs/self-hosting/`), Guides (`content/docs/guides/`), API Reference (`content/docs/reference/`). Tab order is `content/docs/meta.json`.
