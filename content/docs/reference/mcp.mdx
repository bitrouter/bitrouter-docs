...
One is how you reach BitRouter; the other is how BitRouter reaches your tools. See [Tools](/docs/features/tools) for the gateway, and [Agent Skill](/docs/overview/quickstart) for the third way an agent drives BitRouter.
