...
- [Server tools](/docs/mcp-and-tool-calling/server-tools) — let BitRouter run the tool-calling loop for you, server-side.
- [Toolsets](/docs/mcp-and-tool-calling/server-tools#how-tools-are-bundled-toolsets) — how the tools advertised on a request are bundled and namespaced.
