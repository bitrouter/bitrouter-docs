...
span 模型与归因见 [可观测性](/docs/features/observability)，各后端的具体配置见
[导出 trace 到你的 OTel 后端](/docs/guides/export-telemetry)。
...
<Cards>
  ...
  <Card title="可观测性" href="/docs/features/observability" description="OTLP trace + 指标导出与按请求归因。" />
