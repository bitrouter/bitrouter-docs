...
- [Advisor](/docs/models-and-routing/tool-calling/advisor) — consult a stronger model for guidance instead of delegating a task
- [Fusion](/docs/models-and-routing/tool-calling/fusion) — deliberate across a panel of models on one prompt
