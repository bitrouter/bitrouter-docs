...
/* magicui tweet-card (client variant). Renders a real tweet by id via
   react-tweet's `useTweet`, styled with the app's Tailwind tokens so it
   inherits the dark mono theme. Based on https://magicui.design/docs/components/tweet-card */
...
/** ClientTweetCard — fetches and renders a tweet by id on the client. */
