...
- [MCP gateway](/docs/usage/mcp-gateway) — proxy MCP servers so agents discover tools across hosts.
- [ACP gateway](/docs/models-and-routing/acp-gateway) — first-class support for the Agent Client Protocol used by Claude Code, Codex, OpenCode, and others.
...
| MCP Gateway | MCP gateway | [MCP](/docs/usage/mcp-gateway) |
| A2A Agent Gateway | ACP gateway | [ACP](/docs/models-and-routing/acp-gateway) |
| Skills Gateway / `/skills` endpoint | Skills gateway with [agentskills.io](https://agentskills.io) registry | [Agent Skills](/docs/usage/mcp-gateway) |
